...
<div className="flex-1 overflow-y-auto p-3">
  ...
  <div className="flex flex-col gap-4">
    {/* Message from the user (sent message) */}
    <div className="flex items-start justify-end space-x-2">
      <div className="flex-shrink-0"></div> {/* Empty div to push message to the right */}
    ...
    {/* Message from the opposite person (received message) */}
    <div className="flex items-start space-x-2">
      <div className="relative flex-shrink-0 w-8 h-8 rounded-full overflow-hidden">
        <img src="https://tailwindui.com/placeholder-user.jpg" alt="User" className="object-cover w-full h-full" />
      </div>
      <div className="bg-blue-100 p-2 rounded-lg max-w-xs text-left">
        <p className="text-sm">Hi, I'm doing well, thank you! How about you?</p>
      </div>
    </div>
  </div>
</div>
