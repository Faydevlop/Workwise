                    ...
                    >
                      ...
                      <div
                        className={`p-2 rounded-lg max-w-xs ${
                          msg.sender === sender ? 'bg-blue-100' : 'bg-blue-100'
                        }`}
                      >
                      ...
                      {msg.sender === sender && (
                        <div className="relative flex-shrink-0 w-8 h-8 rounded-full overflow-hidden">
                          <img
                            src={hr.hr.profileImageUrl ? hr.hr.profileImageUrl : 'https://i.pinimg.com/564x/00/80/ee/0080eeaeaa2f2fba77af3e1efeade565.jpg' }
                            alt="User"
                            className="object-cover w-full h-full"
                          />
                        </div>
