  ...
  useEffect(() => {
    ...
    const fetchDetails = async ()=>{
        try {
            ...
            setEmail(response.data.department.email)
            setPhone(response.data.department.phone)
            setTeamMembers(response.data.department.TeamMembers)
  ...
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      ...
      <div className="bg-blue-50" style={{ flex: 3, padding: '20px', overflow: 'auto' }}>
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-l-xl shadow-md mx-auto">
          ...
          <div className="mb-6">
            <h3 className="font-semibold mb-4"> Available Team Members</h3>
