...
const AdminSignin = () => {
  ...
  if (Object.keys(errors).length === 0) {
    ...
    dispatch(registerAuth({ username, email, password })).unwrap()
    .then(()=>{
  ...
  return (
   <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                ...
                <div
                    className="absolute inset-0 my-auto h-[730px]"
                    style={{
                        background: "blue"
                    }}
                >
                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Already have an account? <a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500">
                              <Link to={'/admin/login'}>
                              Log in
                              </Link>
